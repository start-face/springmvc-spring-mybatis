    ...
    <div class="container_fluid">
        ...
        <nav class="collapse navbar-collapse" id="bjui-navbar-collapse">
            <ul class="nav navbar-nav navbar-right" id="bjui-hnav-navbar">
                <li class="active">
                    <a href="/common/json/menu-form.json" data-toggle="sidenav" data-id-key="targetid">表单相关</a>
                </li>
                <li>
                    <a href="/common/json/menu-base.json" data-toggle="sidenav" data-id-key="targetid">基础组件</a>
                </li>
                <li>
                    <a href="/common/json/menu-datagrid.json" data-toggle="sidenav" data-id-key="targetid">数据表格</a>
                </li>
            </ul>
        </nav>
    </div>
